...
import { SiFilament, SiLaravel, SiMysql, } from "react-icons/si";
  ...
  return (
    <div id="tech" className="flex min-h-[70vh] w-full flex-col items-center justify-center gap-16 md:gap-32">
      ...
      <div className="flex flex-wrap items-center justify-center gap-10 p-5">
        ...
        whileInView="visible"
        transition={{ duratio: 0.5 }}>
          <SiLaravel className="cursor-pointer text-[80px] text-orange-500 transition-all duration-300 hover:-translate-y-5 sm:text-[100px] md:text-[120px]" />
        </motion.div>
        ...
        whileInView="visible"
        transition={{ duratio: 0.5 }}>
          <SiFilament className="cursor-pointer text-[80px] text-orange-500 transition-all duration-300 hover:-translate-y-5 sm:text-[100px] md:text-[120px]" />
        </motion.div>
